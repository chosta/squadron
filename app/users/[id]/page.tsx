            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
              ...
              <div className="flex-1 text-center sm:text-left">
                ...
                {user.ethosDescription && (
                  <p className="mt-3 text-gray-600">{user.ethosDescription}</p>
                )}
                <div className="mt-4 flex flex-wrap justify-center sm:justify-start gap-4 text-sm">
                  ...
                  {user.ethosXHandle && (
                    <a
                      href={`https://x.com/${user.ethosXHandle}`}
                      target="_blank"
                    ...
                    >
                      ...
                      <span>@{user.ethosXHandle}</span>
                    </a>
                  )}
                </div>
                {user.ethosPrimaryWallet && (
                  <div className="mt-4">
                    <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-gray-100 rounded-lg text-sm text-gray-600 font-mono">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />
                      </svg>
                      <span>
                        {user.ethosPrimaryWallet.slice(0, 6)}...{user.ethosPrimaryWallet.slice(-4)}
                      </span>
                    </div>
                  </div>
                )}
