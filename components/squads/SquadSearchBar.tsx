  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className="block w-full pl-10 pr-10 py-2 bg-space-800 border border-space-600 rounded-lg text-hull-100 placeholder:text-hull-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
      />
      {query && (
        <button
          onClick={() => setQuery('')}
